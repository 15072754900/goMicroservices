...
func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, thirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	...
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, thirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultThirdPaymentModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, newData *ThirdPayment) error {
	...
	looklookPaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheThirdPaymentIdPrefix, data.Id)
	looklookPaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheThirdPaymentSnPrefix, data.Sn)
