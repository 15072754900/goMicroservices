...
var (
	...
	cacheLookCpUserAuthIdPrefix              = "cache:lookCp:userAuth:id:"
	cacheLookCpUserAuthAuthTypeAuthKeyPrefix = "cache:lookCp:userAuth:authType:authKey:"
	cacheLookCpUserAuthUserIdAuthTypePrefix  = "cache:lookCp:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Delete(ctx context.Context, id int64) error {
	...
	lookCpUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	lookCpUserAuthIdKey := fmt.Sprintf("%s%v", cacheLookCpUserAuthIdPrefix, id)
	lookCpUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
		return conn.ExecCtx(ctx, query, id)
	}, lookCpUserAuthAuthTypeAuthKeyKey, lookCpUserAuthIdKey, lookCpUserAuthUserIdAuthTypeKey)
	return err
}
...
func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	lookCpUserAuthIdKey := fmt.Sprintf("%s%v", cacheLookCpUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, lookCpUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	lookCpUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, lookCpUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	lookCpUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, lookCpUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	lookCpUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	lookCpUserAuthIdKey := fmt.Sprintf("%s%v", cacheLookCpUserAuthIdPrefix, data.Id)
	lookCpUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheLookCpUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
...
func (m *defaultUserAuthModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheLookCpUserAuthIdPrefix, primary)
}
