...
var (
	...
	cacheLookCpUserIdPrefix     = "cache:lookCp:user:id:"
	cacheLookCpUserMobilePrefix = "cache:lookCp:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	lookCpUserIdKey := fmt.Sprintf("%s%v", cacheLookCpUserIdPrefix, id)
	lookCpUserMobileKey := fmt.Sprintf("%s%v", cacheLookCpUserMobilePrefix, data.Mobile)
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("delete from %s where `id` = ?", m.table)
		return conn.ExecCtx(ctx, query, id)
	}, lookCpUserIdKey, lookCpUserMobileKey)
	return err
}
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	lookCpUserIdKey := fmt.Sprintf("%s%v", cacheLookCpUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, lookCpUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	lookCpUserMobileKey := fmt.Sprintf("%s%v", cacheLookCpUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, lookCpUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	lookCpUserIdKey := fmt.Sprintf("%s%v", cacheLookCpUserIdPrefix, data.Id)
	lookCpUserMobileKey := fmt.Sprintf("%s%v", cacheLookCpUserMobilePrefix, data.Mobile)
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheLookCpUserIdPrefix, primary)
}
