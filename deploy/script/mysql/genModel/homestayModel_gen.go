...
var (
	...
	cacheLookCpHomestayIdPrefix = "cache:lookCp:homestay:id:"
)
...
func (m *defaultHomestayModel) withSession(session sqlx.Session) *defaultHomestayModel {
	return &defaultHomestayModel{
...
func (m *defaultHomestayModel) Delete(ctx context.Context, id int64) error {
	lookCpHomestayIdKey := fmt.Sprintf("%s%v", cacheLookCpHomestayIdPrefix, id)
...
func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	lookCpHomestayIdKey := fmt.Sprintf("%s%v", cacheLookCpHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, lookCpHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultHomestayModel) Insert(ctx context.Context, data *Homestay) (sql.Result, error) {
	lookCpHomestayIdKey := fmt.Sprintf("%s%v", cacheLookCpHomestayIdPrefix, data.Id)
...
func (m *defaultHomestayModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheLookCpHomestayIdPrefix, primary)
}
